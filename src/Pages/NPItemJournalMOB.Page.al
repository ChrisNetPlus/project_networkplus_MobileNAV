...
page 50900 "NP Item Journal MOB"
{
                ...
                action(ItemTrackingLines)
                {
                    ...
                    begin
                        if Rec.TrackingExists() then begin
                            CreateItemTrackingLines(false);
                            Commit();
                        end;
                        Rec.OpenItemTrackingLines(false);
                        UpdateItemTracking(Rec);
                    end;
                }
                action("Bin Contents")
                {
    ...
    begin
        ...
        if GetItemTracking(TempTrackingSpecification) then
